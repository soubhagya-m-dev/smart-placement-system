...
export default function Notifications() {
  ...
  const getBgColor = (notif) => {
    if (isReminder(notif)) return 'bg-amber-50 border-amber-300';
    const t = notif?.type;
    switch (t) {
        ...
        <div className="max-w-2xl mx-auto px-4 py-4 flex items-center gap-4">
          ...
          {unreadCount > 0 && (
            <button
              ...
              className="inline-flex items-center gap-1.5 text-sm font-medium text-blue-600 hover:text-blue-800 hover:bg-blue-50 px-3 py-1.5 rounded-lg transition-colors"
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {notif.job && (notif.job._id || notif.job) && (
                      <button
                        ...
                        className="inline-flex items-center gap-1 text-blue-600 text-sm mt-2 hover:text-blue-800 hover:underline font-medium"
                      >
                    ...
                    {isReminder(notif) && (notif.job?._id || notif.job) && (
                      <button
                        ...
                        className="inline-flex items-center gap-1 text-amber-700 text-sm mt-2 hover:text-amber-900 hover:underline font-semibold"
                      >
                        <ExternalLink className="w-3 h-3" />
                        View Details
                      </button>
